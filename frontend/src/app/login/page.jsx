...
const DEMO = { email: "alex@invoicer.ai", password: "password123" };
      ...
      >
        ...
        <form onSubmit={onSubmit} className="mt-9 space-y-4">
          ...
          <button
            type="button"
            onClick={fillDemo}
            className="w-full h-12 rounded-2xl border border-dashed border-[var(--accent)]/40 bg-[var(--accent-soft)]/40 text-sm font-semibold text-[var(--accent-strong)] hover:bg-[var(--accent-soft)] transition-colors inline-flex items-center justify-center gap-2 cursor-pointer"
          >
