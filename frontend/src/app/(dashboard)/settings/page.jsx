          ...
          <div>
            ...
            {form.logo_url && (
              <button
                ...
                className="ml-2 text-xs text-[var(--danger)] font-semibold cursor-pointer"
              >
                Remove
              </button>
            )}
...
function ThemeOption({ value, label, icon: Icon, current, onSelect }) {
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex-1 flex flex-col items-start gap-3 p-4 rounded-2xl border text-left transition-all cursor-pointer",
        active
